...
genD(I1,D,DMax) :- 
    ( D=I1
    ; I1<DMax, I2 is I1+1, genD(I2,D,DMax)
    ).


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% Homework: Consider the following variant of the blocks world problem:

%% Blocks [a,b,c] and places [p,q,r] are given.
%% Action: to(Block,Y,Z): Put Block from Y to Z.
%% Note: Each of Y and Z can be a place or a block.
%% The other details are the same.

%% Rewrite the program with the main procedure plan_safe/3 in order to solve this variant.
